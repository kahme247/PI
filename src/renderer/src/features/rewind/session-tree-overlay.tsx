    ...
    >
      ...
      >
        ...
        <div ref={listRef} className="scrollbar-overlay min-h-0 flex-1 overflow-y-auto px-2 py-2">
          {!sessionFile ? (
            <p className="px-3 py-8 text-center text-[12px] text-muted-foreground">No session selected</p>
            ...
            <p className="px-3 py-8 text-center text-[12px] text-destructive">Failed to load: {treeError}</p>
          ) : visible.length === 0 ? (
            <p className="px-3 py-8 text-center text-[12px] text-muted-foreground">No matching nodes</p>
          ) : (
            <>
              {truncated && (
